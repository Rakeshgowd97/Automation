...
test('Early Access Automation', async ({ page }) => {
    ...
    await page.locator("//input[@id='mobile-number']").fill('9000000011');
     await page.locator("//button[@id='phonenumber-next']").click();
    await page.locator("//input[@id='name']").fill('JOHN RAJU');
    await page.waitForTimeout(2000);
    await page.locator("//button[@id='name-next']").click();
    await page.waitForTimeout(2000);
    await page.locator("//input[@id='dob']").fill("2000-12-12");
    await page.waitForTimeout(2000);
    await page.getByPlaceholder('Enter City').fill('Bengaluru');
    await page.waitForTimeout(2000);
    await page.getByPlaceholder('Email ID').fill('rakesh0123@gmail.com');
    await page.waitForTimeout(2000);
